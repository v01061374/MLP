            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="GET" action="{{ url('/orders') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Cart Id</th><th>AddressDetails</th><th>PostalCode</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($orders as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->cart_id }}</td><td>{{ $item->addressDetails }}</td><td>{{ $item->postalCode }}</td>
                                        <td>
